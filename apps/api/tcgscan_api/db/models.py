...
class CardIdentity(Base):
    ...
    game: Mapped[Game] = mapped_column(Enum(Game, name="game"), nullable=False, index=True)
...
class SaleEvent(Base):
    ...
    kind: Mapped[SaleKind] = mapped_column(Enum(SaleKind, name="sale_kind"), nullable=False)
